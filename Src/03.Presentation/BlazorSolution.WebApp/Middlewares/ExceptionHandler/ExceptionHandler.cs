...
using BlazorSolution.Infra.Data.SqlServer.Exceptions;
using BlazorSolution.WebApp.Exceptions;
...
public static class ExceptionHandler
{
    ...
    private static (int StatusCode, string Message, string? Details) MapException(Exception exception)
    {
        return exception switch
        {
            ...
            InfrastructureException infEx => (
                (int)HttpStatusCode.BadRequest,
                infEx.Message,
                infEx.InnerException?.Message
            ),

            EndPointException apiEx => (
                (int)HttpStatusCode.BadRequest,
                apiEx.Message,
                exception.Message
            ),
