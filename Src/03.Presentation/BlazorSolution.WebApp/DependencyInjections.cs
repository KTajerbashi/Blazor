...
using BlazorSolution.WebApp.Common.Swagger;
using BlazorSolution.WebApp.Data;
using BlazorSolution.WebApp.Extensions;
using BlazorSolution.WebApp.Middlewares.ExceptionHandler;
using BlazorSolution.WebApp.Middlewares.LoggingHandler;
...
public static class DependencyInjections
{
    ...
    {
        var assemblies = AssemblyProviderExtensions.GetAssemblies(new string[] { "BlazorSolution" });
